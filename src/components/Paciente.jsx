...
const Paciente = ({ paciente }) => {
    ...
    const formatearFecha = fecha => {
        ...
        return new Intl.DateTimeFormat("es-AR",{dateStyle:"full"}).format(nuevaFecha)
    }
    return (
        <div
        ...
        >
            <p
                className="font-bold uppercase text-indigo-600 my-2"
                >Nombre: {""}
                <span
            ...
            <div
                className="flex justify-end my-5 gap-3"
                >
                <button
                    type="button"
